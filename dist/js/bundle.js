...
"use strict";
eval("\n\nvar _Search = __webpack_require__(/*! ./modules/Search */ \"./src/js/modules/Search.js\");\n\nvar _Search2 = _interopRequireDefault(_Search);\n\nvar _CurretnLocation = __webpack_require__(/*! ./modules/CurretnLocation */ \"./src/js/modules/CurretnLocation.js\");\n\nvar _CurretnLocation2 = _interopRequireDefault(_CurretnLocation);\n\nvar _Weather = __webpack_require__(/*! ./modules/Weather */ \"./src/js/modules/Weather.js\");\n\nvar _Weather2 = _interopRequireDefault(_Weather);\n\nvar _todaysWeatherView = __webpack_require__(/*! ./view/todaysWeatherView */ \"./src/js/view/todaysWeatherView.js\");\n\nvar todaysWeather = _interopRequireWildcard(_todaysWeatherView);\n\nvar _nextDaysWeatherView = __webpack_require__(/*! ./view/nextDaysWeatherView */ \"./src/js/view/nextDaysWeatherView.js\");\n\nvar nextDaysWeatherView = _interopRequireWildcard(_nextDaysWeatherView);\n\nvar _base = __webpack_require__(/*! ./view/base */ \"./src/js/view/base.js\");\n\nvar _showMap = __webpack_require__(/*! ./view/showMap */ \"./src/js/view/showMap.js\");\n\nvar _showWikiContent = __webpack_require__(/*! ./view/showWikiContent */ \"./src/js/view/showWikiContent.js\");\n\nvar _showLocalTimeDate = __webpack_require__(/*! ./view/showLocalTimeDate */ \"./src/js/view/showLocalTimeDate.js\");\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nvar state = {};\n\nvar controlSearch = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(query) {\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n            while (1) {\n                switch (_context.prev = _context.next) {\n                    case 0:\n\n                        // 1. get query from view\n                        if (!query) {\n                            query = (0, _base.getInput)();\n                        }\n                        (0, _base.loader)();\n\n                        if (!query) {\n                            _context.next = 8;\n                            break;\n                        }\n\n                        // 2. new search object and add to state\n                        state.search = new _Search2.default(query);\n\n                        // 3. preapere UI for results\n                        (0, _base.clearInput)();\n\n                        // 4. search\n                        _context.next = 7;\n                        return state.search.getResults();\n\n                    case 7:\n\n                        if (state.search.weatherResult) {\n                            // 5. render results\n                            controlWeather(state.search.weatherResult);\n                            (0, _showWikiContent.updateWikiRes)(state.search.wikiResult);\n\n                            // add results to UI\n                            todaysWeather.showTodaysWeather(state.weather.daysWeather[0]);\n                            state.weather.daysWeather.splice(0, 1);\n                            nextDaysWeatherView.showNextDaysWeather(state.weather.daysWeather);\n                        }\n\n                    case 8:\n\n                        controlMap(state.search.weatherResult.city.coord);\n\n                        (0, _base.clearLoader)();\n\n                    case 10:\n                    case 'end':\n                        return _context.stop();\n                }\n            }\n        }, _callee, undefined);\n    }));\n\n    return function controlSearch(_x) {\n        return _ref.apply(this, arguments);\n    };\n}();\n\nvar controlWeather = function controlWeather(forecast) {\n\n    state.weather = new _Weather2.default();\n    state.weather.setWeather(forecast);\n    for (var i = 0; i < 5; i++) {\n        state.weather.generateDate(forecast, i);\n        var date = state.weather.daysWeather[i].date;\n        state.weather.calculateTempMax(forecast.list, date, i);\n        state.weather.calculateTempMin(forecast.list, date, i);\n        state.weather.generateIcon(forecast, i);\n        state.weather.rain(forecast, i);\n        state.weather.calcWind(forecast, i);\n    }\n};\n\nvar controlMap = function controlMap(latLng) {\n    (0, _showMap.showMap)(latLng);\n};\n\n_base.elements.searchBtn.addEventListener('click', function (e) {\n    e.preventDefault();\n    controlSearch();\n});\n\nwindow.addEventListener('load', _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n    return regeneratorRuntime.wrap(function _callee2$(_context2) {\n        while (1) {\n            switch (_context2.prev = _context2.next) {\n                case 0:\n                    state.city = new _CurretnLocation2.default();\n                    _context2.next = 3;\n                    return state.city.getResults();\n\n                case 3:\n                    controlSearch(state.city.cityName);\n\n                case 4:\n                case 'end':\n                    return _context2.stop();\n            }\n        }\n    }, _callee2, undefined);\n})));\n\n//# sourceURL=webpack:///./src/js/index.js?");

/***/ }),

/***/ "./src/js/modules/CurretnLocation.js":
/*!*******************************************!*\
  !*** ./src/js/modules/CurretnLocation.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _axios = __webpack_require__(/*! axios */ \"./node_modules/axios/index.js\");\n\nvar _axios2 = _interopRequireDefault(_axios);\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Search = function () {\n    function Search(query) {\n        _classCallCheck(this, Search);\n\n        this.query = query;\n    }\n\n    _createClass(Search, [{\n        key: 'getResults',\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var proxy, key, resWeather, resWiki;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                // recive API without domain\n                                proxy = 'https://cors-anywhere.herokuapp.com/';\n                                // the API key from www.food2fork.com\n\n                                key = 'ec4a7d7f52eccdce20c3d822e10336c1';\n                                _context.prev = 2;\n                                _context.next = 5;\n                                return (0, _axios2.default)(proxy + 'https://api.openweathermap.org/data/2.5/forecast?q=' + this.query + '&units=metric&appid=' + key);\n\n                            case 5:\n                                resWeather = _context.sent;\n\n                                this.weatherResult = resWeather.data;\n                                _context.next = 12;\n                                break;\n\n                            case 9:\n                                _context.prev = 9;\n                                _context.t0 = _context['catch'](2);\n\n                                alert(_context.t0 + (' Cant find such location as ' + this.query));\n\n                            case 12:\n                                _context.prev = 12;\n\n                                this.query = this.query.replace(' ', '%20');\n                                this.query = this.query.split(',')[0];\n                                _context.next = 17;\n                                return (0, _axios2.default)(proxy + 'https://en.wikipedia.org/api/rest_v1/page/summary/' + this.query);\n\n                            case 17:\n                                resWiki = _context.sent;\n\n                                this.wikiResult = resWiki;\n\n                                _context.next = 24;\n                                break;\n\n                            case 21:\n                                _context.prev = 21;\n                                _context.t1 = _context['catch'](12);\n\n                                alert(_context.t1);\n\n                            case 24:\n                            case 'end':\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[2, 9], [12, 21]]);\n            }));\n\n            function getResults() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getResults;\n        }()\n    }]);\n\n    return Search;\n}();\n\nexports.default = Search;\n\n//# sourceURL=webpack:///./src/js/modules/Search.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.showNextDaysWeather = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\nvar showNextDaysWeather = exports.showNextDaysWeather = function showNextDaysWeather(forecast) {\n    _base.elements.nextDaysWeather.forEach(function (element, index) {\n        element.innerHTML = '\\n            <div class=\"forecast-header\">\\n                <div class=\"day\">' + forecast[index].date.day + '</div>\\n            </div>\\n            <div class=\"forecast-content\">\\n                <div class=\"forecast-icon\">\\n                    <img src=\"https://raw.githubusercontent.com/romanserk/romanserk.github.io/master/dist/images/icons/icon-' + forecast[index].icon + '.svg\" alt=\"\" width=48>\\n                </div>\\n                <div class=\"degree\">' + forecast[index].tempMax + '<sup>o</sup>C</div>\\n                <small>' + forecast[index].tempMin + '<sup>o</sup></small>\\n            </div>\\n        ';\n    });\n};\n\n//# sourceURL=webpack:///./src/js/view/nextDaysWeatherView.js?");

/***/ }),

/***/ "./src/js/view/showLocalTimeDate.js":
/*!******************************************!*\
  !*** ./src/js/view/showLocalTimeDate.js ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.showLocalTime = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\nvar showLocalTime = exports.showLocalTime = function showLocalTime(timeAndDate) {\n    _base.elements.localTimeElem.innerHTML = '\\n      <p>' + timeAndDate.date + '</p>\\n      <p>' + timeAndDate.time + '</p>\\n    ';\n};\n\n//# sourceURL=webpack:///./src/js/view/showLocalTimeDate.js?");

/***/ }),

/***/ "./src/js/view/showMap.js":
/*!********************************!*\
  !*** ./src/js/view/showMap.js ***!
  \********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.showMap = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\nvar showMap = exports.showMap = function showMap(latLng) {\n\n    var myLatLng = {\n        lat: latLng.lat,\n        lng: latLng.lon\n    };\n\n    var map = new google.maps.Map(_base.elements.mapElement, {\n        zoom: 12,\n        center: myLatLng,\n        styles: [{\n            elementType: 'geometry',\n            stylers: [{\n                color: '#242f3e'\n            }]\n        }, {\n            elementType: 'labels.text.stroke',\n            stylers: [{\n                color: '#242f3e'\n            }]\n        }, {\n            elementType: 'labels.text.fill',\n            stylers: [{\n                color: '#746855'\n            }]\n        }, {\n            featureType: 'administrative.locality',\n            elementType: 'labels.text.fill',\n            stylers: [{\n                color: '#d59563'\n            }]\n        }, {\n            featureType: 'poi',\n            elementType: 'labels.text.fill',\n            stylers: [{\n                color: '#d59563'\n            }]\n        }, {\n            featureType: 'poi.park',\n            elementType: 'geometry',\n            stylers: [{\n                color: '#263c3f'\n            }]\n        }, {\n            featureType: 'poi.park',\n            elementType: 'labels.text.fill',\n            stylers: [{\n                color: '#6b9a76'\n            }]\n        }, {\n            featureType: 'road',\n            elementType: 'geometry',\n            stylers: [{\n                color: '#38414e'\n            }]\n        }, {\n            featureType: 'road',\n            elementType: 'geometry.stroke',\n            stylers: [{\n                color: '#212a37'\n            }]\n        }, {\n            featureType: 'road',\n            elementType: 'labels.text.fill',\n            stylers: [{\n                color: '#9ca5b3'\n            }]\n        }, {\n            featureType: 'road.highway',\n            elementType: 'geometry',\n            stylers: [{\n                color: '#746855'\n            }]\n        }, {\n            featureType: 'road.highway',\n            elementType: 'geometry.stroke',\n            stylers: [{\n                color: '#1f2835'\n            }]\n        }, {\n            featureType: 'road.highway',\n            elementType: 'labels.text.fill',\n            stylers: [{\n                color: '#f3d19c'\n            }]\n        }, {\n            featureType: 'transit',\n            elementType: 'geometry',\n            stylers: [{\n                color: '#1e202b'\n            }]\n        }, {\n            featureType: 'transit.station',\n            elementType: 'labels.text.fill',\n            stylers: [{\n                color: '#d59563'\n            }]\n        }, {\n            featureType: 'water',\n            elementType: 'geometry',\n            stylers: [{\n                color: '#1e202b'\n            }]\n        }, {\n            featureType: 'water',\n            elementType: 'labels.text.fill',\n            stylers: [{\n                color: '#515c6d'\n            }]\n        }, {\n            featureType: 'water',\n            elementType: 'labels.text.stroke',\n            stylers: [{\n                color: '#1e202b'\n            }]\n        }]\n    });\n\n    var marker = new google.maps.Marker({\n        position: myLatLng,\n        map: map\n    });\n};\n\n//# sourceURL=webpack:///./src/js/view/showMap.js?");

/***/ }),

/***/ "./src/js/view/showWikiContent.js":
/*!****************************************!*\
  !*** ./src/js/view/showWikiContent.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.updateWikiRes = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\nvar updateWikiRes = exports.updateWikiRes = function updateWikiRes(content) {\n    if (content.data.originalimage) {\n        console.log(content.data.originalimage.source);\n    }\n\n    _base.elements.wikiContainer.innerHTML = '\\n        <p>' + content.data.extract + '</p>\\n        <img src=' + (content.data.originalimage == !undefined ? content.data.originalimage.source : undefined) + '>\\n    ';\n};\n\n//# sourceURL=webpack:///./src/js/view/showWikiContent.js?");

/***/ }),

/***/ "./src/js/view/todaysWeatherView.js":
/*!******************************************!*\
  !*** ./src/js/view/todaysWeatherView.js ***!
  \******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.showTodaysWeather = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\nvar showTodaysWeather = exports.showTodaysWeather = function showTodaysWeather(todayWeather) {\n\n    _base.elements.todayWeather.innerHTML = '\\n        <div class=\"forecast-header\">\\n            <div class=\"day\">' + todayWeather.date.day + '</div>\\n            <div class=\"date\">' + todayWeather.date.month + '</div>\\n        </div>\\n        <div class=\"forecast-content\">\\n            <div class=\"location\">' + todayWeather.city + '</div>\\n            <div class=\"degree\">\\n                <div class=\"num\">' + todayWeather.tempMax + '<sup>o</sup>C</div>\\n                <div class=\"today-icon forecast-icon\">\\n                    <img src=\"https://raw.githubusercontent.com/romanserk/romanserk.github.io/master/dist/images/icons/icon-' + todayWeather.icon + '.svg\" alt=\"\" width=90>\\n                </div>\\n            </div>\\n            <span><img src=\"https://raw.githubusercontent.com/romanserk/romanserk.github.io/master/dist/images/icon-umberella.png\" alt=\"\">' + todayWeather.rain + 'mm</span>\\n            <span><img src=\"https://raw.githubusercontent.com/romanserk/romanserk.github.io/master/dist/images/icon-wind.png\" alt=\"\">' + todayWeather.wind.speed + 'km/h</span>\\n            <span><img src=\"https://raw.githubusercontent.com/romanserk/romanserk.github.io/master/dist/images/icon-compass.png\" alt=\"\">' + todayWeather.wind.dir + '</span>\\n        </div>\\n    ';\n};\n\n//# sourceURL=webpack:///./src/js/view/todaysWeatherView.js?");
...
/***/ 0:
/*!**************************************************************!*\
  !*** multi babel-polyfill ./src/js/index.js ./src/main.scss ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

eval("__webpack_require__(/*! babel-polyfill */\"./node_modules/babel-polyfill/lib/index.js\");\n__webpack_require__(/*! ./src/js/index.js */\"./src/js/index.js\");\nmodule.exports = __webpack_require__(/*! ./src/main.scss */\"./src/main.scss\");\n\n\n//# sourceURL=webpack:///multi_babel-polyfill_./src/js/index.js_./src/main.scss?");
