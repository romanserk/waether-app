...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.showNextDaysWeatherWeather = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/view/base.js\");\n\nvar showNextDaysWeatherWeather = exports.showNextDaysWeatherWeather = function showNextDaysWeatherWeather(forecast) {\n    var listNumber = forecast.list.length - 4;\n    _base.elements.nextDaysWeather.forEach(function (element, index) {\n        element.innerHTML = '\\n            <div class=\"forecast-header\">\\n                <div class=\"day\">' + (0, _base.generateDate)(forecast, index + 1).day + '</div>\\n            </div>\\n            <div class=\"forecast-content\">\\n                <div class=\"forecast-icon\">\\n                    <img src=\"images/icons/icon-' + (0, _base.generateIcon)(forecast.list[listNumber]) + '.svg\" alt=\"\" width=48>\\n                </div>\\n                <div class=\"degree\">' + (0, _base.calculateTempMax)(forecast, forecast.list[listNumber]) + '<sup>o</sup>C</div>\\n                <small>' + (0, _base.calculateTempMin)(forecast, forecast.list[listNumber - 4]) + '<sup>o</sup></small>\\n            </div>\\n        ';\n        listNumber -= 8;\n    });\n};\n\n//# sourceURL=webpack:///./src/js/view/nextDaysWeatherView.js?");
